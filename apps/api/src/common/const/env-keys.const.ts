...
export const ENV_CLOUDINARY_CLOUD_NAME_KEY = 'CLOUDINARY_CLOUD_NAME';

// CLOUDINARY_API_KEY
export const ENV_CLOUDINARY_API_KEY = 'CLOUDINARY_API_KEY';

// CLOUDINARY_API_SECRET
export const ENV_CLOUDINARY_API_SECRET = 'CLOUDINARY_API_SECRET';
